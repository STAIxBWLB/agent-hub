...
Status: 0.6.3. All six milestones of the design spec are implemented; the [smoke checklist](docs/smoke.md)
...
```bash
bun add -g github:STAIxBWLB/agent-hub#v0.6.3 && ahub setup
```
